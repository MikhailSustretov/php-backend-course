<head>
    ...
    <script src="/public/scripts/data_collection/incrementCounters.js"></script>
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="http://libraryServer" class="navbar-brand"><span class="sh">Ш</span><span
                            class="plus">++</span></a></div>
            </div>
            <div class="col-xs-12 col-sm-7 col-md-8 col-lg-8">
                <div class="main-menu">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <form class="navbar-form navbar-right" action="http://libraryServer/" method="get">
                            <div class="form-group">
                                <input id="search" name="search" type="text" placeholder="Найти книгу"
                                       class="form-control">
                                <div class="loader"><img src="/template/books-page_files/gifs/loading.gif"></div>
